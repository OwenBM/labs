...
export class Jot {
    constructor(title, body, CreatedAt, UpdatedAt, id) {
        this.title = title
        this.body = body
    ...
    jotCard() {
        return `
        <div id="left-jot-cards" class="card rounded container-fluid card-width jot-bg text-light m-2 btn" role="button" onclick="app.JotService.setActiveJot('${this.id}')">
            <div class="row p-2 ">
